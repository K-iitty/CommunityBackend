...
public class RedisConfig {
    ...
    public RedisMessageListenerContainer redisMessageListenerContainer(RedisConnectionFactory connectionFactory) {
        ...
        // 监听其他模块的特定消息
        container.addMessageListener(redisMessageListener, new PatternTopic("community:property:change"));
        container.addMessageListener(redisMessageListener, new PatternTopic("community:admin:change"));
        
        // 监听通知消息
        container.addMessageListener(redisMessageListener, new PatternTopic("community:owner:notification"));
