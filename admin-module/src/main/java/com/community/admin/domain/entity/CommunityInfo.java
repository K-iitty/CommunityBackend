package com.community.admin.domain.entity;
...
public class CommunityInfo {
     ...
     * @return 社区图片URL列表
     */
    public List<String> getCommunityImagesList() {
        if (communityImages == null || communityImages.isEmpty()) {
            return List.of();
        }
        return Arrays.asList(communityImages.split(","));
    }
     ...
     * @return 是否有社区图片
     */
    public boolean hasCommunityImages() {
        return communityImages != null && !communityImages.isEmpty();
    }
}