...
public interface ComplexBusinessService {
     ...
     * @return 是否成功
     */
    boolean addVehicleForOwner(Long ownerId, com.community.admin.domain.entity.Vehicle vehicle);
     ...
     * @return 是否成功
     */
    boolean addParkingSpaceForOwner(Long ownerId, com.community.admin.domain.entity.ParkingSpace parkingSpace);
     ...
     * @return 是否成功
     */
    boolean addFamilyMemberForOwner(Long ownerId, com.community.admin.domain.entity.Owner familyMember);
     ...
     * @return 是否成功
     */
    boolean addMeterInfoForOwnerHouse(Long ownerId, Long houseId, com.community.admin.domain.entity.MeterInfo meterInfo);
     ...
     * @return 是否成功
     */
    boolean generateMeterChargeRecord(Long ownerId, com.community.admin.domain.entity.MeterReading meterReading);
     ...
     * @return 是否成功
     */
    boolean addMeterForOwner(Long ownerId, com.community.admin.domain.entity.MeterInfo meterInfo);
     ...
     * @return 是否成功
     */
    boolean assignNoticeToBuilding(Long buildingId, com.community.admin.domain.entity.CommunityNotice notice);
     ...
     * @return 是否成功
     */
    boolean assignNoticeToCommunity(Long communityId, com.community.admin.domain.entity.CommunityNotice notice);
